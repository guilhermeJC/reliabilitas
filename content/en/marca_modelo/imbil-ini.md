...
taxonomia:
  ...
  - dinamicas
  - bomba-centrifuga
resumo: 'The Brazilian standardized pump — Imbil (Itapira/SP), ISO 2858 dimensions, the national standard for sanitation and general industry with local support.'
fontes:
  - 'Imbil — official INI line page (imbil.com.br/produtos/ini/)'
  - 'Imbil — INI line technical catalog (NBR/ISO 2858 dimensions, back pull-out construction)'
tags:
  - ISO 2858
  - standardized pump
  - sanitation
...
- [INI line page — Imbil](https://imbil.com.br/produtos/ini/) — description, applications and engineering contact.
- Catalogs and manuals in Imbil's official download center (D05 — always the official source).

## Reliability

No published MTBF (the industry rule). In water service inside the BEP, the standardized-class profile holds — and the dominant MTBF factor is installation/operation discipline, not brand (the 3× spread between plants running the same machine — see "Reliability in numbers" in the [[bomba-centrifuga|Centrifugal Pump]] handbook). Factory proximity is a maintainability asset: lower MTTR through logistics, not higher MTBF by design.
