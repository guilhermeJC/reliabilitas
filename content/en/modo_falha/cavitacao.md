...
plano_manutencao:
  - tarefa: 'Analyze high-frequency band vibration'
    metodo: 'Spectrum + envelope with pump under load; broadband 10–25 kHz energy modulated by BPF; compare against healthy-machine baseline'
    periodicidade: 'Monthly (P-F/2)'
  - tarefa: 'Inspect suction and volute acoustically'
    metodo: 'Ultrasound/stethoscope with pump under load; continuous "gravel" noise; distinguish from air entrainment (tightness test)'
  ...
  - tarefa: 'Inspect the impeller visually'
    metodo: 'Boroscopy at opportunity shutdowns; pit morphology (rough edges, clean metal) and depth vs repair criterion'
