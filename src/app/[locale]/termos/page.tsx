...
// 2 seções ancoradas (#uso / #privacidade). Base legal anti-scraping
// (BR-004) + cobertura explícita da retenção do campo `contato` opcional
// em sugerir/colaborar (DEV-083 #6). Rascunho: aviso visível até o
// fundador confirmar a versão final (mesmo padrão de gate editorial do
// resto do conteúdo — publicado, depois revisado ao vivo).
